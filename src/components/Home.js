  ...
  return (
    <div className="Homepage">
      ...
      <p>
        ...
        involved in mathematics, and the term math magician should not be taken too literally.
        You can use these smaller chunks as separate paragraphs or combine them into a single
        paragraph if it makes more sense for your content.
      </p>
    </div>
  );
}
